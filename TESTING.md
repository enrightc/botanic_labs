...
| Add Product      |     18/10/24       |   See bug reports       |    Pass       |
| Edit Product     |            |          |           |
| Bag              |   17/10/24         |          |    Pass       |
...
To resolve this issue:
	...
	1. Remove the id attribute from the custom widget. and instead added a class="new-image" to the input field for file selection in the forms.py.
