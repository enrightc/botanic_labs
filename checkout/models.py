import uuid # Used to generate unique order number

from django.db import models
from django.db.models import Sum # used to calculate the total of all line items in an order
from django.conf import settings # imports free delivery threshold and standard delivery percentage from project settings
...
class Order(models.Model):
    ...
    def _generate_order_number(self):
        ...
        # .hex turns uuid into hexidecimal string. No dashes, a continuous string of characters
